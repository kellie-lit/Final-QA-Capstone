...
export class NewPage {
    ...
    cityInput: By = By.id('cityInput')
    submitBtn: By = By.id('submitCity')
    articleBtn: By = By.className('newsCardBtn')
    newsWeatherPage: string = 'https://bp-foundations-capstone.herokuapp.com/newsWeather.html'
