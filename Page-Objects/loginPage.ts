...
export class LoginPage {
    driver: WebDriver
    url: string = 'https://research.alpha-sense.com/login/userId/'
    signIn: By = By.className('username__3JgWym9f')
    userInput: By = By.id('username__3JgWym9f')
    nextBtn: By = By.id('next-step')
    pwInput: By = By.id('password')
    signInBtn: By = By.className('asui-button asui-primary marginButton__1SYcORnT')
    loginPage: string = 'https://research.alpha-sense.com/login/password/'
